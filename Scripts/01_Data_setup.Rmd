...
weight83_86_data<-mbirth2 %>% 
  select(basebrgy,hhldnubi, basewman, daybirth, dayintw, mothintw, yearintw, weight1, weightak, weightgm )
...
height83_86_data<-mbirth2 %>% 
  select(basebrgy,hhldnubi, basewman, daybirth, dayintw, mothintw, yearintw, heightcm )
