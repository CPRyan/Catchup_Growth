...
anthdiet <-anthdiet %>% 
  mutate(logfolds = log10(skinfold_sum_02), 
         density = dw_c_m_02 - (dw_m_m_02 * logfolds), 
         bfperc = ((4.95/density )-4.5)*100,
         fatmass = (( bfperc *.01)*weight_02),
         fatfree_mass = weight_02-fatmass)
...
anthdiet05 <-anthdiet05 %>% 
  ...
  select(basebrgy_basewman, age, weight_05, height_05, bmi_05, waist_05, hip_05, whr_05, armcircm_05, subscap_mean, supra_mean, tricep_mean, arm_musc_area) %>% 
...
anthdiet05 <-anthdiet05 %>% 
  mutate(logfolds = log10(skinfold_sum), 
         density = dw_c_m_05 - (dw_m_m_05 * logfolds), 
         bfperc = ((4.95/density )-4.5)*100,
         fatmass = (( bfperc *.01)*weight_05),
         fatfree_mass = weight_05-fatmass)
