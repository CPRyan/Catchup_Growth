...
weight_mlong_bday_1 <- weight_mlong_bday %>% 
  select(basebrgy_basewman, sexchild, date_inf_meas, age_days_infweigh, birthdate, "wght_1")

weight_mlong_bday_12 <- weight_mlong_bday %>% 
  select(basebrgy_basewman, sexchild, date_inf_meas, age_days_infweigh, birthdate, "wght_12")


weight_mlong_bday_1 <- addWGSR(data = weight_mlong_bday_1, sex = "sexchild", firstPart= "wght_1", secondPart = "age_days_infweigh", index = "wfa") %>% 
...
height_mlong_bday_1 <- height_mlong_bday %>% 
  select(basebrgy_basewman, sexchild, date_inf_meas, age_days_infweigh, birthdate, "hght_1")
...
height_mlong_bday_1 <- addWGSR(data = height_mlong_bday_1, sex = "sexchild", firstPart= "hght_1", secondPart = "age_days_infweigh", index = "hfa") %>% 
...
growth_data<- growth_data_unfiltered %>% 
  select(basebrgy_basewman, sexchild, sex, outcome, birthdate, intwdate, weightak_kg, heightcm, age_days_birthweigh, date_infweigh,    )
```
