...
grim_weight_b_2_f<-lm(AgeAccelGrim ~ wfa_diff_birth_inf12, subset(growth_clocks_data, sex == "2")) 
...
grim_weight_83_91_f<-lm(AgeAccelGrim ~ wfa_diff_inf12_91, subset(growth_clocks_data, sex == "2"))

grim_weight_83_91_m<-lm(AgeAccelGrim ~ wfa_diff_inf12_91, subset(growth_clocks_data, sex == "1"))
