...
intersect(names(zscore_data), names(growth02_data))
...
grim_hbirth_min_f<-lm(AgeAccelGrim ~ hfa_diff_birth_inf12, subset(growth_clocks_data, sex == "2"))
grim_hbirth_min_f

grim_hbirth_min_m<-lm(AgeAccelGrim ~ hfa_diff_birth_inf12, subset(growth_clocks_data, sex == "1"))
grim_hbirth_min_m
...
grim_hinf12_min_f<-lm(AgeAccelGrim ~ hfa_diff_inf12_91, subset(growth_clocks_data, sex == "2"))
grim_hbirth_min_f

grim_hinf12_min_m<-lm(AgeAccelGrim ~ hfa_diff_inf12_91 , subset(growth_clocks_data, sex == "1"))
grim_hinf12_min_m
...
grim_h91_min_f<-lm(AgeAccelGrim ~ hfa_diff_91_02, subset(growth_clocks_data, sex == "2"))
grim_h91_min_f

grim_h91_min_m<-lm(AgeAccelGrim ~ hfa_diff_91_02, subset(growth_clocks_data, sex == "1"))
grim_h91_min_m
...
grim_wbirth_min_f<-lm(AgeAccelGrim ~ wfa_diff_birth_inf12, subset(growth_clocks_data, sex == "2")) 
grim_wbirth_min_f

grim_wbirth_min_m<-lm(AgeAccelGrim ~ wfa_diff_birth_inf12, subset(growth_clocks_data, sex == "1"))
grim_wbirth_min_m
...
grim_winf12_min_f<-lm(AgeAccelGrim ~ wfa_diff_inf12_91, subset(growth_clocks_data, sex == "2"))
grim_winf12_min_f

grim_winf12_min_m<-lm(AgeAccelGrim ~ wfa_diff_inf12_91, subset(growth_clocks_data, sex == "1"))
grim_winf12_min_m
